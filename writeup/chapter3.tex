...
%   \{0.025,0.05,0.1\}$, $k=1$, $\omega=0.9$, $\alpha = 10^{-5}$, $N\in \{400,200,100\}$.}\label{fig:rcirchist_n_ma1}
% 	\begin{center}
% \includegraphics[width=.33\textwidth]{figs/rcirc_hist_u_L_0025_w_09_k_1_sims_5000.png}\hfill
% \includegraphics[width=.33\textwidth]{figs/rcirc_hist_u_L_05_w_09_k_1_sims_5000.png}\hfill
% \includegraphics[width=.33\textwidth]{figs/rcirc_hist_u_L_01_w_09_k_1_sims_5000.png}
% 	\end{center}
% \end{figure}
...
% \begin{figure}[H]\linespread{1}
% \caption[Average number of period $p$ orbits for the random circle
% map (normal distribution), for $\alpha=10^{-5}$, $\omega=0.9$ and $k=1.5$]{Average number of period $p$ orbits for the random circle
% map, where 5000 simulations are plotted. The error bars indicate
% the standard error of the calculation of the mean. $L \in
%   \{0.05,0.1,0.9\}$, , $\omega=0.9$, $k=1$, $\alpha = 10^{-5}$, $N\in \{200,100,100\}$.}\label{fig:rcirchist_n_ma2}
% 	\begin{center}	\includegraphics[width=.33\textwidth]{figs/rcirc_hist_u_L_005_w_09_k_15_sims_5000.png}\hfill
% \includegraphics[width=.33\textwidth]{figs/rcirc_hist_u_L_01_w_09_k_15_sims_5000.png}\hfill
% \includegraphics[width=.33\textwidth]{figs/rcirc_hist_u_L_09_w_09_k_15_sims_5000.png}
% 	\end{center}
% \end{figure}
