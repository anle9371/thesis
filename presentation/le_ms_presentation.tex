...
\begin{figure}[h]
\centering
\includegraphics[width=.495\textwidth]{rlog_hist_L_01_r_33_s_0017565_a_15414e-05_sims_5000}\hfill
\includegraphics[width=.495\textwidth]{rlog_hist_L_01_r_33_sims_5000semilogy}
\end{figure}
}
\end{frame}
...
\end{frame}
%------------------------------------------------
\fbckg{tongues_norm_halfa_1000_L_01} 
\begin{frame}
\end{frame}
%------------------------------------------------
\fbckg{tongues_n_ma_1000_L_0125} 
\begin{frame}
\end{frame}
%------------------------------------------------
\fbckg{tongues_n_ma_1000_L_015} 
\begin{frame}
\end{frame}
%------------------------------------------------
\fbckg{tongues_n_ma_1000_L_0175} 
\begin{frame}
\end{frame}
%------------------------------------------------
\fbckg{tongues_n_ma_1000_L_02} 
\begin{frame}
\end{frame}
%------------------------------------------------
\fbckg{tongues_n_ma_1000_L_0225} 
\begin{frame}
\end{frame}
%------------------------------------------------
\fbckg{tongues_n_ma_1000_L_025} 
\begin{frame}
\end{frame}
%------------------------------------------------
\fbckg{tongues_n_ma_1000_L_0275} 
\begin{frame}
\end{frame}
...
\end{frame}
% %------------------------------------------------
% \fbckg{tongues_norm_halfa_1000_L_03} 
% \begin{frame}
% \end{frame}
%------------------------------------------------
...
\begin{figure}[h]
\centering
\includegraphics[width=.495\textwidth]{rcirc_hist_n_L_01_w_06_k_1_sims_5000}\hfill
...
\fbckg{blank}
\begin{frame}
\misc{ Devil's Staircase
\begin{figure}[h]
\centering
\includegraphics[width=.495\textwidth]{detcirc_devil_k1}\hfill
\includegraphics[width=.495\textwidth]{rcirc_n_devil_k1_L005}
\end{figure}
}
\end{frame}
%------------------------------------------------
\fbckg{blank}
\begin{frame}
\misc{ Distribution of Rotation Number
\begin{figure}[h]
\centering
